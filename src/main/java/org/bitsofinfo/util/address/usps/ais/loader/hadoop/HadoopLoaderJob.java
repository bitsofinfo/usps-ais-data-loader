 ...
 * jobs submitted to the HadoopDataLoader
 * 
 * @author bitsofinfo.g [at] gmail [dot] com
 *
 */
public class HadoopLoaderJob implements LoaderJob {

	private USPSDataProcessor dataProcessor = null;
	...
	protected HadoopLoaderJob(String identifier, List<FileHandle> sourceData, USPSDataProcessor targetProcessor, HadoopDataLoader dataLoader) {
		this.dataProcessor = targetProcessor;
