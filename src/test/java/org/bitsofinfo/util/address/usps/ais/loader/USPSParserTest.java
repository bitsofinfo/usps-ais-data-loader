...
public class USPSParserTest extends AbstractJUnit4SpringContextTests {
	...
	public void parseCityStateSample() throws Exception {
		...
		List<USPSRecord> records = uspsParser.parseData(USPSProductType.CITY_STATE, copyright, lines);
		
		assert(records.size() == 58);
